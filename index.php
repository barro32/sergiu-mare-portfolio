			...
			<div class="holder">
				...
				<div class="cf">
					...
					<div class="desc left">
						...
						<p class="text">I understand the needs of the business and of the user, so I place the
			...
			<div class=" holder">
				...
				<ul class="tiles mod">
					<li class="tile cf">
						...
						<h3 class="sub-title">Structure</h3>
						<p class="text">Semantic markup made with HTML5, is very important for the struncture and the SEO of the webpage.</p>
					</li>
					<li class="tile cf">
						<div class="icon">
						...
						<p class="text">Usage of CSS3 at the maximum level can avoid JavaScript and make the web-page lighter and faster.
					...
					<li class="tile cf">
						...
						<h3 class="sub-title">Functionality</h3>
						<p class="text">The magic in the interaction with the user is defined by javaScript. It gives us the possibility
